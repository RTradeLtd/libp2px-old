...
func TestNetworkSetup(t *testing.T) {
	...
	mn := New(ctx, zaptest.NewLogger(t))
...
func TestStreams(t *testing.T) {
	...
	mn, err := FullMeshConnected(context.Background(), zaptest.NewLogger(t), 3)
	if err != nil {
		t.Fatal(err)
	}
...
func TestStreamsStress(t *testing.T) {
	...
	mn, err := FullMeshConnected(context.Background(), zaptest.NewLogger(t), nnodes)
	if err != nil {
		t.Fatal(err)
	}
...
func TestAdding(t *testing.T) {
	mn := New(context.Background(), zaptest.NewLogger(t))
...
func TestLimitedStreams(t *testing.T) {
	mn, err := FullMeshConnected(context.Background(), zaptest.NewLogger(t), 2)
	if err != nil {
		t.Fatal(err)
	}
...
func TestFuzzManyPeers(t *testing.T) {
	...
	for i := 0; i < peerCount; i++ {
		_, err := FullMeshConnected(context.Background(), zaptest.NewLogger(t), 2)
		if err != nil {
			t.Fatal(err)
		}
	}
...
func TestStreamsWithLatency(t *testing.T) {
	...
	mn, err := WithNPeers(context.Background(), zaptest.NewLogger(t), 2)
	if err != nil {
		t.Fatal(err)
	}
